          ...
          <div class=" col-12  col-sm-6 col-md-4 d-flex align-items-stretch ">
            <div class="card bg-light ">
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-7">
                    <h1 class="lead h1" style="font-family:'Advent Pro', sans-serif; font-weight: bold; color: #C77129; font-size: 1.5rem;text-transform: uppercase;"><b>
                        <?php
...
<div class="modal fade" id="modal-novoUsuario">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" style="font-family: 'Advent Pro', sans-serif; font-weight: 500; letter-spacing: 1px; color:orange">Novo
          Cliente</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <div class="modal-body">
        ...
        <form class="needs-validation" novalidate action="./pages/pages/acoes/gravaNovoCliente.php" method="POST" enctype="multipart/form-data">
          ...
          <fieldset>
            <legend>
              <h1 class="lead text-orange" style="font-family:'Advent Pro', sans-serif; font-weight: bold;">
                DADOS DE CONTATOS
              </h1>
            </legend>
          </fieldset>
